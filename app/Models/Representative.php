...
class Representative
{
    ...
    public function create($data)
    {
        ...
        $sql = "INSERT INTO representatives (nome_completo, cpf, birth_date, email, telefone, cep, logradouro, numero, complemento,
    ...
    public function update($id, $data)
    {
        ...
        $allowedFields = [
            'nome_completo', 'cpf', 'cep', 'logradouro', 'numero', 'complemento',
            'bairro', 'cidade', 'uf', 'telefone', 'email', 'birth_date', 'photo', 'status'
        ];
