    ...
    <div class="bg-white rounded-lg shadow">
        ...
        <form method="POST" action="<?= url('estabelecimentos') ?>" enctype="multipart/form-data" class="p-6">
            ...
            <div class="mb-8">
                ...
                <!-- Campos PJ (Pessoa Jurídica: CPF e Data de Nascimento do responsável são exigidos para PagBank) -->
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    registrationTypeInputs.forEach(input => {
        input.addEventListener('change', function() {
            if (this.value === 'PF') {
                ...
                // Campos obrigatórios para PJ (CPF e Data de Nascimento do responsável)
                const cpfPj = document.querySelector('input[name="cpf_pj"]');
                const dataNasc = document.querySelector('input[name="data_nascimento"]');
    ...
    // Definir required nos campos PJ ao carregar se tipo for PJ
...
include __DIR__ . '/../layouts/app.php';
?>
>>>>>>> a0a5c53aae1ff590aadefd967ae21b90fc2cd514
