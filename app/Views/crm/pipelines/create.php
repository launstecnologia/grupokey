...
<div class="pt-6 px-4 max-w-2xl mx-auto">
    ...
    <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Novo Pipeline</h1>
    ...
    <form method="POST" action="<?= url('crm/pipelines') ?>" class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
        <?= csrf_field() ?>
