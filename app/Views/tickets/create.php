...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <p class="text-muted mb-0">Crie um novo chamado de suporte</p>
    </div>
    <div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select shadow-sm" id="produto" name="produto" required>
                                ...
                                <option value="CDC" <?= ($_POST['produto'] ?? '') === 'CDC' ? 'selected' : '' ?>>CDC</option>
                                <option value="CDX_EVO" <?= ($_POST['produto'] ?? '') === 'CDX_EVO' ? 'selected' : '' ?>>CDX/EVO</option>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea class="form-control shadow-sm" id="descricao" name="descricao" rows="8" 
                                      placeholder="Descreva detalhadamente o problema, incluindo passos para reproduzir, se aplicável..." required><?= htmlspecialchars($_POST['descricao'] ?? '') ?></textarea>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                <a href="<?= url('chamados') ?>" class="btn btn-secondary shadow-sm">
